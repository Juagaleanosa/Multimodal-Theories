...
st.markdown("""
    <div style="background-color: #3A3B46; padding: 10px; border-radius: 15px;">
        <p style="text-align: center;">
           Para citar este artículo: Dávila, M. V., Tamayo, A. Ó. E., Galeano, S. J. A. (2024). Philodatagrapher (versión 1) [Aplicación móvil].Streamlit.app.https://philodatagrapher.streamlit.app.https://philodatagrapher.streamlit.app.
        </p>
    </div>
